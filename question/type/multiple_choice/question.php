...
abstract class qtype_multiple_choice_base extends question_graded_automatically {
    ...
    public function apply_attempt_state(question_attempt_step $step) {
        ...
        foreach ($this->order as $ansid) {
            ...
            $a = new stdClass();
            $a->id = 0;
            $a->answer = html_writer::span(get_string('deletedchoice', 'qtype_multiple_choice'),
                    'notifyproblem');
 ...
 */
class qtype_multiple_choice_single_question extends qtype_multiple_choice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_multiple_choice', 'single');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectananswer', 'qtype_multiple_choice');
    }
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class qtype_multiple_choice_multi_question extends qtype_multiple_choice_base {
    public function get_renderer(moodle_page $page) {
        return $page->get_renderer('qtype_multiple_choice', 'multi');
    }
    ...
    public function get_validation_error(array $response) {
        ...
        return get_string('pleaseselectatleastoneanswer', 'qtype_multiple_choice');
    }
